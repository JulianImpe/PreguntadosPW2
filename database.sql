...
ADD COLUMN token_validacion VARCHAR(6) NULL,
ADD COLUMN token_expira DATETIME NULL,
ADD COLUMN email_validado TINYINT(1) DEFAULT 0;
...
INSERT INTO usuarios (
    ...
    NULL, 'Editor del Sistema', 1, 2, 0, NULL, 'Argentina', 'Buenos Aires',
    NULL, NULL
);
...
INSERT INTO usuarios (
    ...
    NULL, 'Jugador Normal', 1, 1, 0, NULL, 'Argentina', 'Buenos Aires',
    NULL, NULL
);
...
INSERT INTO usuarios (
    usuario, password, email, fecha_nac, foto_perfil, nombre_completo,
    Sexo_ID, Rol_ID, Puntaje_total, Mapa_ID, pais, ciudad,
    token_validacion, token_expira, email_validado
) VALUES (
    'AshKetchum', 'pikachu123', 'ash@pokemon.com', '1997-04-01',
    NULL, 'Ash Ketchum', 1, 1, 9850, NULL, 'Argentina', 'Pueblo Paleta',
    NULL, NULL, 1
);
...
INSERT INTO usuarios (
    ...
    'GaryOak', 'rival123', 'gary@pokemon.com', '1997-04-01',
    NULL, 'Gary Oak', 1, 1, 8920, NULL, 'Argentina', 'Pueblo Paleta',
    NULL, NULL, 1
);
...
INSERT INTO usuarios (
    ...
    'MistyWilliams', 'starmie456', 'misty@pokemon.com', '1998-03-15',
    NULL, 'Misty Williams', 2, 1, 7650, NULL, 'Argentina', 'Ciudad Celeste',
    NULL, NULL, 1
);
...
INSERT INTO usuarios (
    ...
    'BrockHarrison', 'onix789', 'brock@pokemon.com', '1995-10-08',
    NULL, 'Brock Harrison', 1, 1, 6890, NULL, 'Argentina', 'Ciudad Plateada',
    NULL, NULL, 1
);
...
INSERT INTO usuarios (
    ...
    'SerenaYvonne', 'fennekin321', 'serena@pokemon.com', '1999-05-25',
    NULL, 'Serena Yvonne', 2, 1, 5420, NULL, 'Argentina', 'Ciudad Carmín',
    NULL, NULL, 1
);
...
INSERT INTO Partida (Usuario_ID, Estado_ID, Hora_inicio, Hora_finalizacion, Puntaje_obtenido)
VALUES 
    (4, 2, '2025-01-10 10:00:00', '2025-01-10 10:15:00', 180),
    (4, 2, '2025-01-12 14:30:00', '2025-01-12 14:50:00', 250),
    (4, 2, '2025-01-15 16:00:00', '2025-01-15 16:20:00', 320), 
    (4, 2, '2025-01-17 18:00:00', '2025-01-17 18:25:00', 290),
    (4, 2, '2025-01-20 20:00:00', '2025-01-20 20:18:00', 270);


INSERT INTO Partida (Usuario_ID, Estado_ID, Hora_inicio, Hora_finalizacion, Puntaje_obtenido)
VALUES 
    (5, 2, '2025-01-11 11:00:00', '2025-01-11 11:18:00', 200),
    (5, 2, '2025-01-13 15:30:00', '2025-01-13 15:48:00', 260),
    (5, 2, '2025-01-16 17:00:00', '2025-01-16 17:22:00', 310), 
    (5, 2, '2025-01-18 19:00:00', '2025-01-18 19:20:00', 280),
    (5, 2, '2025-01-21 12:00:00', '2025-01-21 12:15:00', 240);


INSERT INTO Partida (Usuario_ID, Estado_ID, Hora_inicio, Hora_finalizacion, Puntaje_obtenido)
VALUES 
    (6, 2, '2025-01-10 09:00:00', '2025-01-10 09:20:00', 170),
    (6, 2, '2025-01-13 13:00:00', '2025-01-13 13:25:00', 230),
    (6, 2, '2025-01-16 16:30:00', '2025-01-16 16:50:00', 290), 
    (6, 2, '2025-01-19 10:00:00', '2025-01-19 10:22:00', 250),
    (6, 2, '2025-01-22 14:00:00', '2025-01-22 14:18:00', 210);


INSERT INTO Partida (Usuario_ID, Estado_ID, Hora_inicio, Hora_finalizacion, Puntaje_obtenido)
VALUES 
    (7, 2, '2025-01-11 08:00:00', '2025-01-11 08:20:00', 160),
    (7, 2, '2025-01-14 12:00:00', '2025-01-14 12:25:00', 220),
    (7, 2, '2025-01-17 15:00:00', '2025-01-17 15:20:00', 270), 
    (7, 2, '2025-01-20 09:00:00', '2025-01-20 09:20:00', 240),
    (7, 2, '2025-01-23 11:00:00', '2025-01-23 11:15:00', 200);


INSERT INTO Partida (Usuario_ID, Estado_ID, Hora_inicio, Hora_finalizacion, Puntaje_obtenido)
VALUES 
    (8, 2, '2025-01-12 10:30:00', '2025-01-12 10:50:00', 150),
    (8, 2, '2025-01-15 14:00:00', '2025-01-15 14:20:00', 210),
    (8, 2, '2025-01-18 16:00:00', '2025-01-18 16:25:00', 250), 
    (8, 2, '2025-01-21 13:00:00', '2025-01-21 13:18:00', 230),
    (8, 2, '2025-01-24 15:00:00', '2025-01-24 15:20:00', 190);
